                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" data-toggle="tooltip"
                                                                    ...
                                                                    class="btn btn-primary btn-mini waves-effect waves-light btn-round">
                                                                <i class="icofont icofont-ui-edit mr-0"></i></button>
                                                            <button type="button" data-toggle="tooltip"
                                                                    data-placement="top" title=""
                                                                    data-original-title="Xóa"
                                                                    class="btn btn-danger btn-mini waves-effect waves-light btn-round">
